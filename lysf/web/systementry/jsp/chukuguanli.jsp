		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-header" style="border-bottom: 1px solid #e5e5e5;">
					...
					<h4 class="modal-title">社团信息详情</h4>
				</div>
   	...
   	$(function (){
    	...
    	$('#chanpinruku').dataTable({
        	...
        	ajax:{
        		...
        		url:"../chanpinguanli/getguanliteams",	//请求地址
        ...
        $('#chanpinruku tbody').on('click','.chakan', function() {
            ...
            //通过dataTable获取隐藏的值
             qjtid = $('#chanpinruku').DataTable().row(rowIndex).data().tid;


            $.ajax({
                type: 'post',
                url: '../chanpinguanli/getteamxiangqing',
                data: "tid="+qjtid,
                context: document.body,
                success: function (data) {

                    var ckjgfzj= chukuxiangqing(data);
		...
		//构建出库详细的datatable
        function chukuxiangqing(chukuxiangqing) {
        //alert(chukuxiangqing[0].username)
               ...
               // ordering:true,//启动排序
                ...
                columns: [
                    ...
                    { data: null,
                        orderable: false,//制定是否排序
                        //也可以这样添加自己想要的列data-target="#xiugai" data-toggle="modal"
                        defaultContent: '<a href="javascript::##"  title="删除" id="shanchu" class="shanchu"> <i class="iconfont icon-shanchu"></i></a>'
                    }
                ],
                /*通过该属性可以制定columns中的各种属性，包括添加列和字段属性变换等，当然也可以在columns中实现  */
                columnDefs: [
