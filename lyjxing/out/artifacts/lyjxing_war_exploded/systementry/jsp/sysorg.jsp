...
<link
	href="plugins/datatables/extensions/Buttons/css/buttons.dataTables.css"
	rel="stylesheet">
<style type="text/css">
.tog {
...
<body>
						...
						<div class="col-sm-2 col-md-2">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">组织结构管理</h3>
								</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-header">
					...
					<h4 class="modal-title">组织结构添加页面</h4>
				</div>
				...
				<form class="form-horizontal"  id="form2">
					...
					<input type="hidden" name="oparentid" value="" id="oid">
    ...
    var datats=function (treeId){   
    	 ...
    	 $('#sysorg').dataTable({    	
        	...
        	ajax:{
        		...
        		url:"../system/sysorginfo?oid="+treeId,	//请求地址
  ...
  window.onload=datats(1111111);
    	 ...
    	 $('#sysorg tbody').on('click','tr', function() {
   		...
   		$("#add").click(function(){
   			$.ajax({
				...
				success:function(data){ 
					...
					'<td>'+data.ojigouid+'</td>'+
					'<td>'+data.otype+'</td>'+
					'<td>'+data.ozhuangtai+'</td>'+
					'<td>'+data.oparentid+'</td>'+
					...
					$('#sysorg tbody tr:eq(0)').before(newtr);
					
					
					//调用treeadd方法添加树
					var ojigouid=$("#oid").val();
					
					var opid=$("#opid").val();
					
					var nodes={id:ojigouid,pId:opid,name:data.oname};
					
					
					var nodes1=treeObj.getSelectedNodes()
					
			    	 //treeObj.addNodes(nodes1,-1,nodes,true)
					 treeObj.reAsyncChildNodes(nodes1[0], "refresh"); 
				}
			})
   		})
	...
	<SCRIPT type="text/javascript">
        ...
        $(document).ready(function(){    		
            $.fn.zTree.init($("#treeDemo"), setting);
             treeObj = $.fn.zTree.getZTreeObj("treeDemo");//树
